...
public class PieceMovementState : State
{
    ...
    private static async void Promotion(TaskCompletionSource<bool> tcs, bool skipMovement)
    {
        ...
        {
            var affectedPawn = new AffectedPiece();
            affectedPawn.WasMoved = true;
            //affectedPawn.ResetMovement = true;
            affectedPawn.From = AffectedPieces[0].From;
            affectedPawn.To = AffectedPieces[0].To;
    ...
    private static void Castling(TaskCompletionSource<bool> tcs, bool skipMovement)
    {
        ...
        var affectedKing = new AffectedPiece();
        ...
        var affectedRook = new AffectedPiece();
